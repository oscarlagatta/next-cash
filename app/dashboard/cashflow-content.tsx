...
export default function CashflowContent(
    {annualCashflow}: { annualCashflow: {month: number, income: number, expenses: number}[]}) {
        ...
        >
            <BarChart  data={annualCashflow}>
                ...
                <XAxis tickFormatter={(value) => {
                    return format(new Date(today.getFullYear(), value, 1), 'MMM yyyy')
                }}/>
           ...
           <div className="border-l px-4 flex flex-col gap-4 justify-center">
               ...
               <div>
                   ...
                   <h2 className={cn("text-3xl font-bold", balance >= 0 ? "text-lime-600" : "text-orange-600")}>
